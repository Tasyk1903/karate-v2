...
- Существующий приватный S3 подключён. Реальный одноразовый probe с сервера подтвердил запись, чтение, Range 206 и анонимный 403; probe удалён. S3-аудит нового дампа нашёл 154 недостающих пути, включая 4 ранее известных архивных: **докопирование отложено владельцем**. Пользовательские файлы не заменялись и не удалялись.
